        ...
        <tr>
          ...
          <td>
            <form action="{{ route('plantillacorreos.destroy', $Plantillacorreo) }}" method="POST">
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
                <a href="{{route('plantillacorreos.show',$Plantillacorreo)}}" class="btn btn-primary"><span class="glyphicon glyphicon-eye-open"></span></a>
                <a href="{{route('plantillacorreos.edit',$Plantillacorreo)}}" class="btn btn-success"><span class="glyphicon glyphicon-pencil"></span></a>                         
